...
- **HTML elements** \<br\>\</br\>
   ...
   Do take a look at the list of HTML [elements](../reference-html/General/unsupported-elements.md), and [attributes](../reference-html/General/unspported-attributes.md) that are _not_ supported.
