...
Renders a dropdown with menu items. The dropdown must contain a [sp-menu](/uxp-api/reference-spectrum/spectrum-uxp/widgets/user-interface/sp-menu.md) with `slot="options"`, and inside the `sp-menu`, a series of `sp-menu-item` or `sp-menu-divider` elements.
