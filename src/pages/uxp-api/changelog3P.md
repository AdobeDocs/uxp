...
### Deprecations
- [Clipboard.setContent](./reference-js/Global%20Members/Data%20Transfers/Clipboard.md#setContent) is deprecated. Please use [Clipboard.write](./reference-js/Global%20Members/Data%20Transfers/Clipboard.md#write(data)) instead.
...
- Passing an `object` to [Clipboard.writeText(object)](./reference-js/Global%20Members/Data%20Transfers/Clipboard.md#writeText(text)) is deprecated. Please use [Clipboard.write(object)](./reference-js/Global%20Members/Data%20Transfers/Clipboard.md#write(data)) instead.
- [Clipboard.clearContent](./reference-js/Global%20Members/Data%20Transfers/Clipboard.md#clearContent)  is deprecated. [Clipboard.writeText("")](./reference-js/Global%20Members/Data%20Transfers/Clipboard.md#writeText(text)) would be an alternative.
- `uxpvideoload` in HTMLVideoElement has been deprecated. Use [loadeddata](./reference-js/Global%20Members/HTML%20Elements/HTMLVideoElement.md#load) instead.

### New
- New components supported in Spectrum Web Components (SWC). [More detail](https://github.com/adobe/swc-uxp-wrappers/tree/main?tab=readme-ov-file#spectrum-web-components-uxp-wrappers)
  - sp-asset
  - sp-meter
  - sp-number-field
  - sp-overlay
...
- Support for local HTML files in [WebView](./reference-js/Global%20Members/HTML%20Elements/HTMLWebViewElement.md)
...
- Support for new HTMLElement APIs - [append](./reference-js/Global%20Members/HTML%20Elements/HTMLElement.md#append), [prepend](./reference-js/Global%20Members/HTML%20Elements/HTMLElement.md#prepend) and [replaceChildren](./reference-js/Global%20Members/HTML%20Elements/HTMLElement.md#replaceChildren)
...
- [UXP Clipboard.writeText()](./reference-js/Global%20Members/Data%20Transfers/Clipboard.md#writeText) now accepts strings as input to meet standards
