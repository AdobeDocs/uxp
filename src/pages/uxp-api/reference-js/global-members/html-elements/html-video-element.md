...
| --- | --- | --- | --- |
| preload | `string` |  | Determines how much the media data be loaded when the plugin loads. This can be one of: "none" (video should not be loaded), "metadata" (only video metadata is fetched), "auto" (the whole video file can be downloaded), or "" (empty string, synonym of "auto"). Default is "metadata". Example: \<br\>\</br\>`<video src="https://images-tv.adobe.com/mpcv3/b6a5d5f7-5a6c-4bd6-9ee9-ddb6c9c779b3_1564010305.854x480at800_h264.mp4" preload="metadata"></video>` |
...
**Returns**: `string` - How likely it is that the media can be played. One of the following:
