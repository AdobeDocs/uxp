...
Do not store passwords or other secure forms of data using `localStorage`. Instead, use [storage.secureStorage](/uxp-api/reference-js/Modules/uxp/key-value-storage/secure-storage.md)
