...
but will get it by calling [FileSystemProvider.getTemporaryFolder](/uxp/reference-js/Modules/uxp/Persistent%20File%20Storage/Classes/FileSystemProvider/#module-storage-filesystemprovider-gettemporaryfolder),
[FileSystemProvider.getFolder](/uxp/reference-js/Modules/uxp/Persistent%20File%20Storage/Classes/FileSystemProvider/#module-storage-filesystemprovider-getfolder), 
or via [Folder.getEntries](/uxp/reference-js/Modules/uxp/Persistent%20File%20Storage/Classes/Folder/#module-storage-folder-getentries).
...
| options | `any` |  |  |
| [options.type] | `Symbol` | `types.file` | Indicates which kind of entry to create. Pass [folder](/uxp/reference-js/Modules/uxp/Persistent%20File%20Storage/Classes/Folder/) to create a new folder. Note that if the type is file then this method just create a file entry object and not the actual file on the disk. The file actually gets created when you call for eg: write method on the file entry object. |
