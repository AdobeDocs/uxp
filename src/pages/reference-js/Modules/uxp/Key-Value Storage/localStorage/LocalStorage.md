...
Do not store passwords or other secure forms of data using `localStorage`. Instead, use [storage.secureStorage](/reference-js/Modules/uxp/Key-Value%20Storage/secureStorage/SecureStorage/).
